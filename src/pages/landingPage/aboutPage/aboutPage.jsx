    ...
    <div className="text-[--color-dark-variant]">
      ...
      <div className="relative lg:w-1/2 flex justify-center lg:justify-end mt-8 lg:mt-0">
        <div className="relative w-[80%] md:w-[60%] lg:w-[75%]">
          <img src={heroImage} alt="Cashew Processing" className="rounded-lg shadow-xl" />
          <img
      ...
      <section className="bg-[--color-cashew-green] text-white py-16 text-center">
        ...
        <button className="mt-6 bg-[--color-cashew-orange] text-white px-6 py-3 font-bold rounded-lg">Get in Touch</button>
      </section>
      <Footer/>
    </div>
  );
